...
class SystemUsers extends TRecord
{
    ...
    public function getListas()
    {
        ...
        return Lista::getObjects( $criteria );
    }

    public function set_lista_system_user_to_string($lista_system_user_to_string)
    {
        if(is_array($lista_system_user_to_string))
        {
            $values = SystemUsers::where('id', 'in', $lista_system_user_to_string)->getIndexedArray('name', 'name');
            $this->lista_system_user_to_string = implode(', ', $values);
        }
        else
        {
            $this->lista_system_user_to_string = $lista_system_user_to_string;
        }

        $this->vdata['lista_system_user_to_string'] = $this->lista_system_user_to_string;
    }

    public function get_lista_system_user_to_string()
    {
        if(!empty($this->lista_system_user_to_string))
        {
            return $this->lista_system_user_to_string;
        }
    
        $values = Lista::where('system_user_id', '=', $this->id)->getIndexedArray('system_user_id','{system_user->name}');
