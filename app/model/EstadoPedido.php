...
class EstadoPedido extends TRecord
{
    ...
    public function get_pedido_estado_pedido_to_string()
    {
        ...
        $values = Pedido::where('estado_pedido_id', '=', $this->id)->getIndexedArray('estado_pedido_id','{estado_pedido->nome}');
    ...
    public function get_pedido_cliente_to_string()
    {
        ...
        $values = Pedido::where('estado_pedido_id', '=', $this->id)->getIndexedArray('cliente_id','{cliente->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_pedido_quantidade_to_string()
    {
        ...
        $values = Pedido::where('estado_pedido_id', '=', $this->id)->getIndexedArray('quantidade_id','{quantidade->id}');
        return implode(', ', $values);
    }
